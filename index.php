...
if(isset($_POST['submit'])){
    ...
    mysqli_query($con,"insert into order(name,mobile,foodname) values('$name','$mobile','$foodname')");
}
?>
<!-- hello kibria sir -->
<!DOCTYPE html>
...
<head>
    ...
    <meta name="keywords" content="pizzazz,pizza,burger">
...
<section class="order" id="order">
    ...
    <div class="row">
        ...
        <form method="post">
            ...
            <textarea placeholder="address" name="address" id="address" cols="30" rows="10" required></textarea>

            <button type="submit" class="btn submit" name="submit">Order</button>
...
<section class="footer">
    ...
    <div class="share">
        ...
        <a href="#" class="btn">foodpanda</a>
        <a href="#" class="btn">Hungrynaki</a>
        
    </div>

    <h1 class="credit"> created by <span> Samin </span> | all rights reserved! </h1>
